...
function applyAll() {
  ...
  Object.keys(S.text).forEach(function (k) {
    ...
    if (el && el.innerHTML !== S.text[k]) el.innerHTML = S.text[k];
  });
...
'.wl-dock{position:fixed;right:16px;bottom:88px;z-index:2147483000;display:flex;flex-direction:column;gap:8px}',
